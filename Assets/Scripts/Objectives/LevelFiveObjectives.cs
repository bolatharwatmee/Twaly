...
public class LevelFiveObjectives : MonoBehaviour {
	...
	void Update () {
		...
		if (ParkingTrigger1.touch == true && ParkingTrigger2.touch == true ) {
			ObjectivesTickesNumbers [1].SetActive (true);
		}
		if (stopped () == true) {
			ObjectivesTickesNumbers [2].SetActive (true);
		}
		if (SpeedPumpLimiter.isGoodSpeed == true && ParkingTrigger1.touch == true && ParkingTrigger2.touch == true && stopped () == true ) {
